...
class AirbnbSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        url = ('https://www.airbnb.com/api/v2/explore_tabs?_format=for_explore_search_web&auto_ib=false&currency=USD&fetch_filters=true&guidebooks_per_grid=20&has_zero_guest_treatment=true&hide_dates_and_guests_filters=false&is_guided_search=true&is_new_cards_experiment=true&items_per_grid=100&key=d306zoyjsyarp7ifhu67rjxn52tv0t20&locale=en&metadata_only=false'
              '&query={2}'            '&query_understanding_enabled=true&refinement_paths%5B%5D=%2Fhomes&satori_version=1.2.6&search_type=section_navigation&selected_tab_id=home_tab&show_groupings=true&source=mc_search_bar&supports_for_you_v3=true&timezone_offset=-300&version=1.7.0'                  
              '&price_min={0}&price_max={1}')
        new_url = url.format(self.price_lb, self.price_ub, self.city)
        
        if (int(self.price_lb)  >= 2500):
            url = ('https://www.airbnb.com/api/v2/explore_tabs?_format=for_explore_search_web&auto_ib=false&currency=USD&fetch_filters=true&guidebooks_per_grid=20&has_zero_guest_treatment=true&hide_dates_and_guests_filters=false&is_guided_search=true&is_new_cards_experiment=true&items_per_grid=100&key=d306zoyjsyarp7ifhu67rjxn52tv0t20&locale=en&metadata_only=false'
              '&query={1}'         '&query_understanding_enabled=true&refinement_paths%5B%5D=%2Fhomes&satori_version=1.2.6&search_type=section_navigation&selected_tab_id=home_tab&show_groupings=true&source=mc_search_bar&supports_for_you_v3=true&timezone_offset=-300&version=1.7.0'                  
              '&price_min={0}')
    ...
    def parse_id(self, response):
        ...
        if pagination_metadata.get('has_next_page'):
            ...
            new_url = ('https://www.airbnb.com/api/v2/explore_tabs?_format=for_explore_search_web&auto_ib=false&currency=USD&fetch_filters=true&guidebooks_per_grid=20&has_zero_guest_treatment=true&hide_dates_and_guests_filters=false&is_guided_search=true&is_new_cards_experiment=true&items_per_grid=100&key=d306zoyjsyarp7ifhu67rjxn52tv0t20&locale=en&metadata_only=false'
                      '&query={4}' '&query_understanding_enabled=true&refinement_paths%5B%5D=%2Fhomes&satori_version=1.2.6&search_type=section_navigation&selected_tab_id=home_tab&show_groupings=true&source=mc_search_bar&supports_for_you_v3=true&timezone_offset=-300&version=1.7.0'
            ...
            if (int(self.price_lb) >= 2500):
                url = ('https://www.airbnb.com/api/v2/explore_tabs?_format=for_explore_search_web&auto_ib=false&currency=USD&fetch_filters=true&guidebooks_per_grid=20&has_zero_guest_treatment=true&hide_dates_and_guests_filters=false&is_guided_search=true&is_new_cards_experiment=true&items_per_grid=100&key=d306zoyjsyarp7ifhu67rjxn52tv0t20&locale=en&metadata_only=false'
                      '&query={3}' '&query_understanding_enabled=true&refinement_paths%5B%5D=%2Fhomes&satori_version=1.2.6&search_type=section_navigation&selected_tab_id=home_tab&show_groupings=true&source=mc_search_bar&supports_for_you_v3=true&timezone_offset=-300&version=1.7.0'
    ...
    def parse_reviews(self, response):
        ...
        calendar_url = 'https://www.airbnb.com/api/v2/homes_pdp_availability_calendar?&currency=USD&key=d306zoyjsyarp7ifhu67rjxn52tv0t20&locale=en&listing_id='+str(listing['listing_id'])+'&month=1&year=2020&count=12'
